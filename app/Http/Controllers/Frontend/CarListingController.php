    ...
    public function store(Request $request)
    {
        // dd($request);
        {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'drive_type' => 'required|in:2WD,4WD,AWD,RWD',
                ...
                'cylenders' => 'required|integer',
                'color' => 'required|string|max:255',
                'doors' => 'required|integer',
                'seats' => 'required|integer',
                'horsepower' => 'required|integer',
                'vin' => 'required|string|max:255|unique:car_listings,vin',
            ...
            try {
                ...
                $carListing->drive_type = $request->drive_type;
                ...
                $carListing->fuel_efficiency = $request->fuel_efficiency;
                $carListing->cylenders = $request->cylenders;
                $carListing->color = $request->color;
                $carListing->doors = $request->doors;
                $carListing->seats = $request->seats;
                $carListing->vin = $request->vin;
    ...
    public function update(Request $request, string $id)
    {
        // dd($request);
        {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'seats' => 'required|integer',
                'horsepower' => 'required|integer',
                'vin' => 'required|string|max:255|unique:car_listings,vin,' . $id,
                'address' => 'required|string|max:255',
                'city' => 'required|string|max:255',
                'state' => 'required|string|max:255',
                'zip_code' => 'required|integer',
