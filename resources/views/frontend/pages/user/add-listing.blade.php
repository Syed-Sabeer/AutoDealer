                        ...
                        <div class="user-profile-card">
                            ...
                            <div class="col-lg-12">
                                <div class="add-listing-form">
                                    ...
                                    <form action="{{ route('frontend.car-listings.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label for="price">Price ({{ \App\Helpers\Helper::currencySymbol() }}) <span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="mileage" id="mileage" class="form-control @error('mileage') is-invalid @enderror"
                                                        placeholder="Enter mileage" required value="{{ old('mileage') }}">
                                                    @error('mileage')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="engine_capacity" id="engine_capacity" class="form-control @error('engine_capacity') is-invalid @enderror"
                                                        placeholder="Enter engine capacity" required value="{{ old('engine_capacity') }}">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="any" name="fuel_efficiency" id="fuel_efficiency" class="form-control @error('fuel_efficiency') is-invalid @enderror"
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="cylenders" id="cylenders" class="form-control @error('cylenders') is-invalid @enderror"
                                                        placeholder="Enter no of cylenders" value="{{ old('cylenders') }}">
                                                    @error('cylenders')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="color" id="color" class="form-control @error('color') is-invalid @enderror"
                                                        placeholder="Enter color name" required value="{{ old('color') }}">
                                                    @error('color')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="doors" id="doors" class="form-control @error('doors') is-invalid @enderror"
                                                        placeholder="Enter no of doors" required value="{{ old('doors') }}">
                                                    @error('doors')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="seats" id="seats" class="form-control @error('seats') is-invalid @enderror"
                                                        placeholder="Enter no of seats" required value="{{ old('seats') }}">
                                                    @error('seats')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="horsepower" id="horsepower" class="form-control @error('horsepower') is-invalid @enderror"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="zip_code" id="zip_code" class="form-control @error('zip_code') is-invalid @enderror"
                                                        placeholder="Enter zip code" required value="{{old('zip_code')}}">
                                                    @error('zip_code')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea  name="description" id="description" class="form-control @error('description') is-invalid @enderror" placeholder="Write description"
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="contact_name" id="contact_name" class="form-control @error('contact_name') is-invalid @enderror"
                                                        placeholder="Enter contact name" required value="{{old('contact_name', Auth::user()->name)}}">
                                                    @error('contact_name')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="contact_email" id="contact_email" class="form-control @error('contact_email') is-invalid @enderror"
                                                        placeholder="Enter contact email" required value="{{old('contact_email', Auth::user()->email)}}">
                                                    @error('contact_email')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="contact_phone" id="contact_phone" class="form-control @error('contact_phone') is-invalid @enderror"
                                                        placeholder="Enter contact number" required value="{{old('contact_phone')}}">
                                                    @error('contact_phone')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-12 mt-4">
                                                <div class="form-check">
                                                    <input class="form-check-input @error('agree') is-invalid @enderror" name="agree" type="checkbox" id="agree" {{ old('agree') ? 'selected' : '' }} required>
